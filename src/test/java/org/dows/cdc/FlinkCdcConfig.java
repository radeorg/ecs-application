...
//
///*    @Bean
//    public CdcInitializer cdcInitializer() {
...
////        cdcConfiguration.putTable("ddd",tables);
//        CdcInitializer cdcInitializer = new CdcInitializer();
//        Map<String, StreamExecutionEnvironment> streamExecutionEnvironments = cdcInitializer.genExecution(cdcConfiguration);
//        Set<String> keys = streamExecutionEnvironments.keySet();
//        for (String key : keys) {
//            StreamExecutionEnvironment streamExecutionEnvironment = streamExecutionEnvironments.get(key);
//            streamExecutionEnvironment.execute(key);
//        }
//
